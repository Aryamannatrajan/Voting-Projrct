 ...
 */
public class AdMain3Extended3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("DELETE COMP.CODE");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Logger.getLogger(AdMain3Extended3.class.getName()).log(Level.SEVERE, null, ex);
...
if(response==JOptionPane.OK_OPTION)
{
    ...
    String username = "root";
             try (Connection conn = DriverManager.getConnection(urL,username,pass)) {
                 ...
                 query = "DELETE FROM TBS.VOTERSDATA WHERE COMPCODE = "+jField1;
...
if(response==JOptionPane.OK_OPTION)
{
     ...
     if(CheckDigit(s1))
     {
         // String command1 = "/Users/abhimanyuyadav/NetBeansProjects/AdminVoter/src/adminvoter/javadb/bin/startNetworkServer";
         //Process proc;
...
private boolean CheckDigit(String s)
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdMain3Extended3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(AdMain3Extended3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(AdMain3Extended3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
