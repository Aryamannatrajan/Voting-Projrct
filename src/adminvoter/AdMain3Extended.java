 ...
 */
public class AdMain3Extended extends javax.swing.JFrame {

    /**
     * Creates new form Main2
     */
    public int cc;
    public AdMain3Extended() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(AdMain3Extended.class.getName()).log(Level.SEVERE, null, ex);
...
if(response==JOptionPane.OK_OPTION)
{
    ...
    {
    if(CheckDigit(s1)&&CheckDigit(s2))
    {
...
String urL = "jdbc:mysql://localhost:3306/TBS?zeroDateTimeBehavior=CONVERT_TO_NULL";
    ...
    String username = "root";
       ...
       try (Connection conn = DriverManager.getConnection(urL,username,pass)
           ...
           String query;
           query = "SELECT * FROM VOTERSDATA";
           try (Statement st = conn.createStatement(); ResultSet rs = st.executeQuery(query)) {
               pos =-1;
               while(rs.next())
               {
                   int check = rs.getInt("COMPCODE");
                   
                   int jField1 = Integer.valueOf(s1);
                   int jField2 = Integer.valueOf(s2);
                   if(jField1==check)
                   {
                       String query2 ;
                       query2 = "UPDATE VOTERSDATA SET COMPCODE = "+jField2+" WHERE   COMPCODE = "+jField1;
   ...
   catch(Exception e)
   {
    ...
    {
        JOptionPane.showMessageDialog(null,"Please enter the Old Computer Code!");
        jTextField2.setText(null);
    }
    else if(s2.equals((""))&&!(s1.equals("")))
    {
        JOptionPane.showMessageDialog(null,"Please enter the New Computer Code!");
        jTextField1.setText(null);
    }
    else
    {
...
private boolean CheckDigit(String s)
{
    ...
    public static void main(String args[]) throws SQLException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdMain3Extended.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(AdMain3Extended.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(AdMain3Extended.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
