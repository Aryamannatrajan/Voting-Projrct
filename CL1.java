...
public class CL1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            Socket s = new Socket("172.20.10.4",1234);
            BufferedImage b1 = ImageIO.read(ImageIO.createImageInputStream(s.getInputStream()));
            Image img = b1;
            ImageIcon icn = new ImageIcon(img);
            jLabel1.setIcon(icn);
            
        } catch (IOException ex) {
            Logger.getLogger(CL1.class.getName()).log(Level.SEVERE, null, ex);
        }
